		...
		try {
			if (contactID) {
				...
				if (contact && contact.data && contact.data[0]) {
					let phone = null;
					if (!phone && contact.data[0].Phone) {
						phone = contact.data[0].Phone;
					}

					if (!phone && contact.data[0].field9) {
						phone = contact.data[0].field9;
					}

					if (!phone && contact.data[0].field10) {
						phone = contact.data[0].field10;
					}

					if (!phone && contact.data[0].Phone_Syndicate) {
						phone = contact.data[0].Phone_Syndicate;
					}

					if (!phone && contact.data[0].Phone_KIM) {
						phone = contact.data[0].Phone_KIM;
					}

					if (!phone && contact.data[0].Phone_expert) {
