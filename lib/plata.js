...
class Plata {
	async createPayment(data) {
		try {
					...
					basketOrder: [
						{
							...
							icon: "https://pay.genius.space/img/client-new/logo.svg",
			...
			plataLogger.info(`${data.email} plata order create with data: `, JSON.stringify(payload));
			...
			plataLogger.info(`plata checkout with invoiceId ${response.data.invoiceId} created: `, response.data.pageUrl);
